...
cp iueve.p8 /home/harpo/.lexaloffle/pico-8/carts/
...
if [ -n "$LABEL_FILE" ] && [ "$LABEL_FILE" != "/home/harpo/.lexaloffle/pico-8/iueve_label.png" ]; then
    echo "Copying existing label: $LABEL_FILE"
    cp "$LABEL_FILE" /home/harpo/.lexaloffle/pico-8/carts/iueve_label.png
    cp "$LABEL_FILE" /home/harpo/.lexaloffle/pico-8/iueve_label.png
else
...
./pico8 /home/harpo/.lexaloffle/pico-8/carts/iueve.p8 -export iueve_temp.p8.png
if [ -f "iueve_temp.p8.png" ]; then
    echo "Created .p8.png, now exporting to HTML..."
    ./pico8 iueve_temp.p8.png -export iueve.html
    rm iueve_temp.p8.png
else
